...
class Unirest
{
    ...
    {
        return Unirest::request(\Unirest\HttpMethod::POST, $url, $body, $headers, $username, $password);
    }
    ...
    {
        return Unirest::request(\Unirest\HttpMethod::DELETE, $url, $body, $headers, $username, $password);
    }
    ...
    {
        return Unirest::request(\Unirest\HttpMethod::PUT, $url, $body, $headers, $username, $password);
    }
    ...
    private static function request($httpMethod, $url, $body = NULL, $headers = array(), $username = NULL, $password = NULL)
    {
        ...
        $ch = curl_init();
        if ($httpMethod != \Unirest\HttpMethod::GET) {
        ...
        return new \Unirest\HttpResponse($httpCode, $body, $header);
    }
